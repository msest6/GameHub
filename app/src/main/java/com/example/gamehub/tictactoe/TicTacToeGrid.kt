 ...
 * Sav state i logika (provjera pobjednika, izmjena igrača) žive u TicTacToeViewModel -
 * ovaj composable samo prikazuje stanje i prosljeđuje dodire.
 */
@Composable
fun TicTacToeGrid(navController: NavController, buttonColors: ButtonColors, viewModel: TicTacToeViewModel) {
    val configuration = LocalConfiguration.current
    val screenWidth = configuration.screenWidthDp.dp

    Text(
        text = "Na potezu: ${viewModel.currentPlayer}",
        modifier = Modifier
            .fillMaxWidth()
            .padding(15.dp),
